...
const EmptyStarIcon = props => {
  ...
  return (
    <svg
      className="icon icon--empty-star"
      version="1.1"
      id="EmptyStarIcon"
      ...
      height={height}
    >
      <title id="title">Empty rating</title>
      <path
        fill="#F6E652"
        d="M11.287,54.548c-0.207,0-0.414-0.064-0.588-0.191c-0.308-0.224-0.462-0.603-0.397-0.978l3.091-18.018L0.302,
        22.602c-0.272-0.266-0.37-0.663-0.253-1.024c0.118-0.362,0.431-0.626,0.808-0.681l18.09-2.629l8.091-16.393
...
EmptyStarIcon.propTypes = IconsShape
EmptyStarIcon.defaultProps = DefaultIconShape
export { EmptyStarIcon }
